...
// Contrôleur d'accueil (fallback pour les erreurs 404)
require_once __DIR__ . '/application/controleurs/AccueilControleur.php';

define('BASE_URL', '/MediRDV');

// Autoloader pour les contrôleurs et modèles restants
...
$routes = [
    ...
    'plan-site'              => ['AccueilControleur', 'planSite'],
    'centre-aide'            => ['AccueilControleur', 'centreAide'],
    ...
    'prendre-rdv/creneaux/{id}'   => ['RendezVousControleur', 'creneauxAjax'],
    'rendez-vous/rechercher-ajax' => ['RendezVousControleur', 'rechercherAjax'],
    ...
    'medecin/enregistrer-disponibilites'   => ['MedecinControleur', 'enregistrerDisponibilites'],
    'medecin/exceptions/ajouter'           => ['MedecinControleur', 'ajouterException'],
    'medecin/exceptions/supprimer/{id}'    => ['MedecinControleur', 'supprimerException'],
    'medecin/patients'               => ['MedecinControleur', 'mesPatients'],
    'medecin/dossier-patient/{id}'   => ['MedecinControleur', 'dossierPatient'],
    ...
    'medecin/reporter-rdv/{id}'      => ['MedecinControleur', 'reporterRdv'],
    'medecin/enregistrer-report/{id}'=> ['MedecinControleur', 'enregistrerReport'],
    'medecin/documents-rdv/{id}'     => ['MedecinControleur', 'documentsRdv'],

    // ---- Téléconsultation ----
    'teleconsultation/gerer/{id}'    => ['TeleconsultationControleur', 'gerer'],
    'teleconsultation/activer/{id}'  => ['TeleconsultationControleur', 'activer'],
    'teleconsultation/action/{id}'   => ['TeleconsultationControleur', 'action'],
    'teleconsultation/statut/{id}'   => ['TeleconsultationControleur', 'statut'],
    'teleconsultation/rejoindre/{id}'=> ['TeleconsultationControleur', 'rejoindre'],

    // ---- Consultation ----
    'consultation/gerer/{id}'        => ['ConsultationControleur', 'gerer'],
    'consultation/ordonnance/{id}'   => ['ConsultationControleur', 'ordonnance'],
    'consultation/envoyer-ordonnance/{id}' => ['ConsultationControleur', 'envoyerOrdonnance'],
    'consultation/telecharger-pdf/{id}'    => ['ConsultationControleur', 'telechargerPdf'],

    // ---- Réceptionniste ----
    'receptionniste/accueil'         => ['ReceptionnisteControleur', 'index'],
    ...
    'admin-etablissement/ajouter-medecin'   => ['AdminEtablissementControleur', 'ajouterMedecin'],
    'admin-etablissement/enregistrer-ajout-medecin' => ['AdminEtablissementControleur', 'enregistrerAjoutMedecin'],
    ...
    'admin-etablissement/supprimer-medecin/{id}'=> ['AdminEtablissementControleur', 'supprimerMedecin'],
    ...
    'admin-etablissement/rapport-pdf'       => ['AdminEtablissementControleur', 'rapportPdf'],
    'admin-etablissement/mon-etablissement' => ['AdminEtablissementControleur', 'monEtablissement'],
    ...
    'admin/voir-etablissement/{id}'                => ['AdminControleur', 'voirEtablissement'],
    ...
    'admin/reinitialiser-mot-de-passe/{id}'        => ['AdminControleur', 'reinitialiserMotDePasse'],
    ...
    'admin/statistiques'                           => ['AdminControleur', 'statistiquesGlobales'],
    'admin/rapport-pdf'                            => ['AdminControleur', 'rapportPdf'],
    ...
    'admin/paiements'                              => ['PaiementControleur', 'listeEtablissement'],
    ...
    'admin-etablissement/mon-etablissement' => ['AdminEtablissementControleur', 'monEtablissement'],
    'admin/voir-etablissement/{id}' => ['AdminControleur', 'voirEtablissement'],
    'admin/voir-etablissement/{id}' => ['AdminControleur', 'profilEtablissement'],
];
...
if (isset($routes[$url])) {
    ...
    foreach ($routes as $pattern => $action) {
        ...
        if (preg_match('#^' . $regex . '$#', $url, $matches)) {
            array_shift($matches); // supprime l'élément global
